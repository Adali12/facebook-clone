...
class ClonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clone" do
    assert_difference('Clone.count') do
      post clones_url, params: { clone: { First_name: @clone.First_name, Last_name: @clone.Last_name, comfirm_password: @clone.comfirm_password, email: @clone.email, password: @clone.password } }
    end
  ...
  test "should update clone" do
    patch clone_url(@clone), params: { clone: { First_name: @clone.First_name, Last_name: @clone.Last_name, comfirm_password: @clone.comfirm_password, email: @clone.email, password: @clone.password } }
